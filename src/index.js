...
class API {
  clientId = "8135ad6bb44e056051b7";
  clientSecret = "b01790dd6e52226338db0d03d77cfed326746d22";
...
class UI {
  showProfile({
    ...
    <div class="card card-body mb-3">
      ...
      <div class="repos list-group"></div>
    `;
  }
  ...
  showRepositories(repositories) {
    ...
    repositories.forEach((repo) => {
      ...
      repoItem.setAttribute("href", repo.html_url);
